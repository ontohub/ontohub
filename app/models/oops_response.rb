class OopsResponse < ActiveRecord::Base
  ...
  scope :global, joins('LEFT JOIN symbols_oops_responses ON '\
    'oops_responses.id = symbols_oops_responses.oops_response_id').
    where('symbols_oops_responses.symbol_id' => nil)
